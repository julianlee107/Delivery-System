  ...
  <table width="900" border="1" align="center" cellpadding="0" cellspacing="0"bordercolor="#FFFFFF" bordercolordark="#333333" bordercolorlight="#FFFFFF">
    <tr>
      ...
      <td width="30%" height="43">
        <p align="center"><input type="text" name="cNum" size="20"></p>
      </td>
      <td width="18%" height="43">
        <p align="center">车品名：</p>
      </td>
      <td width="30%" height="43">
        <p align="center"><input type="text" name="cSort" size="20"></p>
      </td>
    </tr>
    <tr>
      ...
      <td width="36%" height="42">
        <p align="center"><input type="text" name="cStyle" size="20"></p>
      </td>
      <td width="18%" height="42">
        <p align="center">载重：</p>
      </td>
      <td width="30%" height="42">
        <p align="center"><input type="text" name="cWeight" size="20">吨</p>
      </td>
    </tr>
    <tr>
      ...
      <td width="36%" height="43">
        <p align="center"><input type="text" name="cUsed" size="20">年</p>
      </td>
      <td width="18%" height="43">
        <p align="center">驾驶员姓名：</p>
      </td>
      <td width="30%" height="43">
        <p align="center"><input type="text" name="pName" size="20"></p>
      </td>
    </tr>
    ...
    <tr>
        ...
        <td width="36%" height="46">
          <p align="center"><input type="text" name="pYear" size="20"></p>
        </td>
        ...
        <td width="30%" height="46">
            <p align="center"><input type="text" name="pNum" size="20"></p>
        </td>
    </tr>
    ...
    <tr>
      ...
      <td width="36%" height="45">
        <p align="center"><input type="text" name="pSort" size="20"></p>
     </td>
      ...
      <td width="30%" height="45">
        <p align="center"><input type="text" name="trans" size="20"></p>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td width="30%" height="45">
        <p align="center"><input type="text" name="pLink" size="20"></p>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td width="84%" height="78" colspan="3">
        <p align="left"><textarea rows="5" name="pRemark" cols="72"></textarea></p>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td width="20%" height="45">
        <p align="center"><input type="text" name="pTime" size="20"></p>
      </td>
