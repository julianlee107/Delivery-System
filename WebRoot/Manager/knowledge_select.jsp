...
<table width="785" height="117" border="1" align="center" cellpadding="0" cellspacing="0"bordercolor="#FFFFFF" bordercolordark="#333333" bordercolorlight="#FFFFFF">
  ...
  <tr>
    <td width="786" height="30" colspan="9" align="right"><a href="knowledge_add.jsp">发布信息...</a></td>
  </tr>
  <tr>
...
sql="select ID,Title,IssueDate,Author,Content from tb_Knowledge ";
try
{
...
%>
 <tr>
    ...
    <td width="108" height="32" align="center"><%=rs.getDate("IssueDate")%></td>
     <td width="209" height="32" align="center"><%=rs.getString("Content")%></td>
